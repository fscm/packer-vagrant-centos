...
# System timezone
timezone ${timezone} --isUtc --ntpservers=0.centos.pool.ntp.org,1.centos.pool.ntp.org,2.centos.pool.ntp,3.centos.pool.ntp.org

# Root password
rootpw --plaintext ${password}
user --name=${username} --password=${password} --plaintext
