...
source "virtualbox-iso" "virtualbox" {
    ...
    #http_content         = { "/kickstart.cfg" = file(local._kickstart_file)}
    http_content         = { "/kickstart.cfg" = templatefile("${local._kickstart_tpl}", {
        domain   = "${var.domain}",
        hostname = "${var.hostname}",
        username = "${var.username}",
        password = "${var.password}",
        timezone = "${var._timezone}"
    })}
